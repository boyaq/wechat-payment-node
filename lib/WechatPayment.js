    ...
    (0, _createClass3.default)(WechatPayment, [{
        ...
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(xml, apiKey) {
                ...
                var notification, decryptedData;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                ...
                                decryptedData = _utils2.default.decryptByAes256Cbc(notification.req_info, apiKey);
                                return _context.abrupt('return', decryptedData);
                ...
                _utils2.default.pipe(req, function (err, data) {
                    ...
                    _utils2.default.parseXML(xml).then(function (notification) {
                        if (type == 'payment') {
                            ...
                            var decryptedData = _utils2.default.decryptByAes256Cbc(notification.req_info, apiKey);
